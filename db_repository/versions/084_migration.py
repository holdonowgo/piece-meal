...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['step_sub_recipe'].columns['extra_data'].drop()
    post_meta.tables['step_sub_recipe'].columns['measurement'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['step_sub_recipe'].columns['extra_data'].create()
    post_meta.tables['step_sub_recipe'].columns['measurement'].drop()
